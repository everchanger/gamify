<template>
  <div class="container max-w-md min-h-full px-4 pb-4 mx-auto font-mono">
    <header class="flex items-center justify-between px-4 py-2 my-2 mb-8 bg-white shadow">
      <nuxt-link to="/app" class="flex items-center space-x-1 ">
